...
# permalink: /projects/PageRank
excerpt: "Implemented the PageRank algorithm in C++ for ranking web pages. This included utilizing both the random surfer model and a recursive approach. For efficient graph representation, I used an Adjacency List. View the code [here](https://github.com/MoreOmkar08/Pagerank)"
date: 2022-04-13
venue: 'NA'
---
